...
CREATE TABLE IF NOT EXISTS layout (
    ...
    linkTop VARCHAR(255) NOT NULL,
    bckg VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS product (
    ...
    stock  INT DEFAULT 1,
    price DECIMAL(10, 2) NOT NULL,
    priceDisc DECIMAL(10, 2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS subproduct_list (
    id SERIAL PRIMARY KEY,
    name VARCHAR(100) NOT NULL,
    photo VARCHAR(255) NOT NULL,
    id_product INT
...
CREATE TABLE IF NOT EXISTS chat (
    ...
    message TEXT,
    dateCr DATE,
    chatfrom VARCHAR(100) NOT NULL,
    chatto VARCHAR(100) NOT NULL,
    id_purchase INT,
    id_user INT,
    id_company INT
);
